...
impl BloomFilter {
    ...
    fn suggest_size_in_bytes(expected_elements: usize) -> usize {
        ...
        while size_in_bytes < usize::MAX / 2
            ...
            ) > BloomFilter::DESIRED_FALSE_POSITIVE_RATE
        {
            size_in_bytes *= 2;
        }
        size_in_bytes
...
mod tests {
    ...
    fn bloom_test_prob_of_false_positive() {
        ...
        assert_eq!(
            ...
            0.025_491_740_593_406_025_f64
        );
        assert_eq!(
            BloomFilter::prob_of_false_positive(1_048_576, 524_288, 2),
            0.013_806_979_447_406_826_f64
        );
    }
    ...
    fn bloom_suggest_size() {
        ...
        let theoretical_optimum = ((expected_elements as f64
            * BloomFilter::DESIRED_FALSE_POSITIVE_RATE.ln())
            / f64::ln(1.0 / 2.0f64.powf(2.0f64.ln())))
        .ceil()
        .div_euclid(8f64) as usize;
        let suggested_size = BloomFilter::suggest_size_in_bytes(expected_elements);
        assert_eq!(suggested_size, 2_097_152);
